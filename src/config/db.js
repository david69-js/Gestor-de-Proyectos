...
async function verifySchemaVersion(pool) {
  try {
    const procedures = [
      'sp_CrearOrganizacion',
      'sp_AsignarUsuarioAOrganizacion',
      'sp_AsignarUsuarioAProyecto',
      'sp_RegistrarUsuarioConInvitacion',
      'sp_ObtenerInformacionUsuario',
      'sp_CompararContrasena',
      'sp_CompararContrasenaPorId',
      'sp_CambiarContrasena',
      'sp_ObtenerUsuarioPorId',
      'sp_EliminarUsuario',
      'sp_ActualizarUsuario',
      'sp_ObtenerProyectosPorOrganizacion',
      'sp_CrearProyecto',
      'sp_ObtenerProyectoPorId',
      'sp_ActualizarProyecto',
      'sp_EliminarProyecto',
      'sp_AgregarParticipante',
      'sp_EliminarParticipante',
      'sp_ObtenerUsuariosPorProyecto',
      'sp_ObtenerTareasPorOrganizacion',
      'sp_CrearTarea',
      'sp_ActualizarTarea',
      'sp_EliminarTarea',
      'sp_AsignarUsuarioATarea',
      'sp_DesasignarUsuarioTarea',
      'sp_CrearAnuncio',
      'sp_ObtenerAnuncio',
      'sp_ObtenerAnunciosPorProyecto',
      'sp_EliminarAnuncio',
      'sp_ObtenerNotificaciones',
      'sp_MarcarNotificacionComoLeida',
      'sp_ObtenerNotificacionesNoLeidas'
    ];
